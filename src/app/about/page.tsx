        ...
        <main className="min-h-screen">
            <div className="min-h-screen flex flex-col justify-between">
              <div className="pt-20 px-8 dark:text-gray-300 md:w-2/3 m-auto">
                  <p>Welcome! These weightlifting calculators and tools are designed to support your workout and let you focus on your lift with as few distractions as possible.</p>
                  <br/>
                  <p>To use the RPE calculator, input the weight, reps and RPE of your last completed set, hit calculate, then view the estimated weight for your target RPE and reps.</p>
                  <br/>
                  ...
                  <br/>
                  <p>Any feedback? <a className='text-blue-500 dark:text-blue-300'  target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSdZgCf4Tu6y-5SvOfZkanyqr0pQj8M9u7-RpRiWFUvL4piTQA/viewform?usp=sf_link">Help us improve</a>!</p>
                  <br/>
