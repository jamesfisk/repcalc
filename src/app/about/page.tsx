      ...
      <main className="min-h-screen">
        <div className="min-h-screen flex flex-col justify-between">
          <div className="pt-20 px-8 dark:text-gray-300 md:w-2/3 m-auto">
            ...
            <br />
            <p>The <a href="/platecalculator" className="text-sky-600">barbell weight calculator</a> shows the total weight of a barbell from the plates you&apos;ve loaded onto it. It only counts plates from a single side and assumes symmetrical loading. For example, 2 45lbs plates would result in 225 lbs total: 2 plates on each side plus a 45 lbs bar.</p>
            <br />
