...
export default function DOTSCalculator() {
  ...
  const buttonClasses =
    "bg-blue-700 text-white font-bold py-3 my-2 px-4 rounded";
  return (
    <div
      data-testid="calc"
            ...
            >
              <div className="flex flex-row">
                <FormControlLabel
                  value="male"
                  control={
                    <Radio checked={isMale} onChange={handleGenderClick} />
                  }
                  label="Male"
                />
                <FormControlLabel
